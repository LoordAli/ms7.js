...
let SFAP = 9000; /*سعر الحساب الواحد الفل داتا*/
let NFAP = 2500; /*سعر الحساب الواحد العادي*/
let URID = '585217195756486656' //مين بيتحوله الكريديت
client.on('message', async message => { 
    ...
    if (message == prefix + 'stock') {
        ...
        message.channel.send(new Discord.RichEmbed().setTitle('💵 Stars Shop 💵') ///1
